...
const legacyEvents = [
  {
    ...
    images: ["/legacy/2017_1.webp", "/legacy/2017_2.webp"],
  },
  {
    year: 2018,
    ...
    images: ["/legacy/2018_1.webp", "/legacy/2018_2.webp"],
  },
  {
    year: 2019,
    ...
    images: ["/legacy/2019_1.webp", "/legacy/2019_2.webp"],
  },
  {
    year: 2022,
    ...
    images: ["/legacy/2022_1.webp", "/legacy/2022_2.webp"],
  },
  {
    year: 2023,
    ...
    images: ["/legacy/2023_1.webp", "/legacy/2023_2.webp"],
  },
  {
    year: 2024,
    ...
    images: ["/legacy/2024_1.webp", "/legacy/2024_2.webp"],
  },
];
              ...
              {years.map((y) => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex shrink-0 items-center justify-center rounded-full border px-4 py-1.5 sm:px-5 sm:py-2 md:px-6 md:py-2.5 text-xs sm:text-sm md:text-base font-semibold transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FFD700]/70 whitespace-nowrap ${active
